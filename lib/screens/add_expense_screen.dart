...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  ...
  final _titleFocusNode = FocusNode(); // اضافه کردن FocusNode
  ...
  void initState() {
    super.initState();
    // وقتی ویجت ساخته شد، فوکوس را روی فیلد عنوان قرار بده
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (eventData != null) {
        setState(() {
          // مقداردهی اولیه لیست شرکت‌کنندگان در هزینه (همه به صورت پیش‌فرض)
          _involvedParticipantIds = eventData.participants
              .map((p) => p.id)
              .toSet();

          // مقداردهی اولیه سهم‌ها (پیش‌فرض ۱ سهم برای همه)
  ...
  void dispose() {
    ...
    _titleFocusNode.dispose(); // پاکسازی FocusNode
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (eventData == null || eventData.participants.isEmpty) {
      return Scaffold(
        ...
        body: const Center(child: Text('ابتدا شرکت‌کننده اضافه کنید')),
      );
    }
                            ...
                            setState(() {
                              ...
                              if (_splitType == 'percent' &&
                                ...
                                for (var id in _involvedParticipantIds) {
                                  ...
                                  _involvedParticipantIds.isNotEmpty) {
                                // در حالت مبلغی، پیش‌فرض مبلغ کل را تقسیم بر تعداد کن
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        maxLines: 3,
                        decoration: InputDecoration(
                          hintText: 'توضیحات بیشتر در مورد هزینه...',
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                          ),
                    ...
                    children: [
                      ...
                      if (_receiptImage != null)
                        ...
                        OutlinedButton.icon(
                          ...
                          label: const Text('انتخاب تصویر رسید'),
